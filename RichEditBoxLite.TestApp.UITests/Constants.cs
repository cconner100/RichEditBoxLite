...
public class Constants
{
    ...
    public readonly static string iOSAppName = "com.cconner100.richeditboxlite.testapp";
    public readonly static string AndroidAppName = "com.cconner100.richeditboxlite.testapp";
